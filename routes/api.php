...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/{userId}/upload-profile-picture', [ProfileController::class, 'uploadProfilePicture'])->name('api.update.profile_picture');
    ...
    Route::get('/get-milestones-by-age', [MilestonesByAgeController::class, 'index']);
